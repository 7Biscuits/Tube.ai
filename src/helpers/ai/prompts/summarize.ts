...
Given a detailed textual description (subtitles/captions) of a YouTube video's content, generate a concise summary highlighting the key points and main ideas.
...
The textual description is {subtitles}
`);